    ...
    def process_functions(self, text):
        ...
        response = openai.ChatCompletion.create(
            ...
            messages=[
                ...
                {
                    "name": "quien_presidente",
                    "description": "quien va a ganar para presidente 2023 en argentina",
                    "parameters": {
                        "type": "object",
                        "properties": {
                        }
